...
public class OlderServiceImpl implements OlderService {
    ...
    @Override
    public Older selectByName(Older older) {
        return olderDao.selectOlderByName(older);
    }

    @Override
    public Older selectById(int id) {
        return olderDao.selectOlderById(id);
    }

    @Override
    public int updatePassword(Older older) {
        return olderDao.updatePassword(older);
    }
